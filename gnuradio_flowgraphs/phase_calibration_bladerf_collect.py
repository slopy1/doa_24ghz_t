...
# Title: BladeRF Phase Calibration [COLLECT]
...
class phase_calibration_bladerf_collect(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BladeRF Phase Calibration [COLLECT]", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BladeRF Phase Calibration [COLLECT]")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "phase_calibration_bladerf_collect")
        ...
        self.soapy_bladerf_source_0.set_bandwidth(0,40_000_000)
        self.soapy_bladerf_source_0.set_bandwidth(1,40_000_000)

        if('Overall' != 'Settings Field'):
            # pass is needed, in case the template does not evaluare anything
            pass
            self.soapy_bladerf_source_0.set_gain(0,rx_gain)


        if('Overall' != 'Settings Field'):
            # pass is needed, in case the template does not evaluare anything
            pass
            self.soapy_bladerf_source_0.set_gain(1,rx_gain)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            10000, #size
            sample_rate/avg_length, #samp_rate
            "Phase Stability", #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_time_sink_x_0.set_update_time(0.1)
        self.qtgui_time_sink_x_0.set_y_axis(-45, 45)

        self.qtgui_time_sink_x_0.set_y_label('Phase (deg)', "")
        ...
        labels = ['Phase Offset', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_number_sink_0.set_title("Phase Calibration Coefficient")

        labels = ['Phase Offset (deg)', '', '', '', '',
            '', '', '', '', '']
        units = ['deg', '', '', '', '',
            '', '', '', '', '']
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 4, 0, 2, 2)
        for r in range(4, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.file_sink_raw_ch1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/mau/doa_24ghz_thesis/data/cal_ch1.32fc', False)
        self.file_sink_raw_ch1.set_unbuffered(False)
        self.file_sink_raw_ch0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/mau/doa_24ghz_thesis/data/cal_ch0.32fc', False)
        self.file_sink_raw_ch0.set_unbuffered(False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, '/home/mau/doa_24ghz_thesis/data/data.txt', False)
        ...
        self.connect((self.low_pass_filter_1, 0), (self.blocks_multiply_conjugate_cc_0, 1))
        self.connect((self.soapy_bladerf_source_0, 0), (self.file_sink_raw_ch0, 0))
        self.connect((self.soapy_bladerf_source_0, 1), (self.file_sink_raw_ch1, 0))
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.sample_rate, 10000, 2000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.sample_rate, 10000, 2000, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(2.425e9, self.sample_rate)
        self.qtgui_time_sink_x_0.set_samp_rate(self.sample_rate/self.avg_length)
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.soapy_bladerf_source_0.set_gain(0, self.rx_gain)
        self.soapy_bladerf_source_0.set_gain(1, self.rx_gain)
...
def main(top_block_cls=phase_calibration_bladerf_collect, options=None):
