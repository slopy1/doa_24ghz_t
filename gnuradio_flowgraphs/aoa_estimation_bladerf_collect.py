...
class aoa_estimation_bladerf_collect(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BladeRF AoA Estimation (Root-MUSIC) [COLLECT]", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BladeRF AoA Estimation (Root-MUSIC) [COLLECT]")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "aoa_estimation_bladerf_collect")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.file_sink_ch1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/mau/doa_24ghz_thesis/data/aoa_ch1.32fc', False)
        self.file_sink_ch1.set_unbuffered(False)
        self.file_sink_ch0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/mau/doa_24ghz_thesis/data/aoa_ch0.32fc', False)
