...
// USB CDC serial is used for communication with Cora Z7 (via USB-C → powered hub)
// Serial object maps to USB CDC when "USB CDC On Boot" is enabled in Arduino IDE
...
void loop() {
    // Process incoming serial data from Cora (USB CDC)
    processSerial();
