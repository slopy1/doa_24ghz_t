...
class phase_calibration_bladerf_collect(gr.top_block):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.file_sink_raw_ch1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/petalinux/data/cal_ch1.32fc', False)
        self.file_sink_raw_ch1.set_unbuffered(False)
        self.file_sink_raw_ch0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/petalinux/data/cal_ch0.32fc', False)
